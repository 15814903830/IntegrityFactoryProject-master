package com.xsylsb.integrity.util.dialog;
...
public abstract class BaseNiceDialog extends DialogFragment {
    ...
    private void initParams() {
        ...
        if (window != null) {
            ...
            //设置dialog宽度
            if (width == 0) {
                lp.width = DensityUtil.getScreenWidth(getContext()) - 2 * DensityUtil.dip2px(getContext(), margin);
            } else if (width == -1) {
                lp.width = WindowManager.LayoutParams.WRAP_CONTENT;
            } else {
                lp.width = DensityUtil.dip2px(getContext(), width);
            }
            ...
            if (height == 0) {
                ...
                lp.height = DensityUtil.dip2px(getContext(), height);
            }
